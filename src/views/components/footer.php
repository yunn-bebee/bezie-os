<footer class="w-full py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div
            ...
            <a href="/" class="flex link justify-center lg:justify-start">
               <img src="src/assets/c/logofull.png" alt="" class="size-40">
            </a>
            <a href="/contact"
                class="flex items-center gap-2 py-3.5 px-7 rounded-md black_border font bg-yellow-400  text-black font-semibold hover:bg-yellow-600 hover:text-white duration-300">
        ...
        <div class="flex justify-between flex-col py-8 min-[500px]:py-14 gap-8 min-[500px]:gap-16 lg:gap-0 lg:flex-row">
            <div
                ...
                <div class="block font-mono">
                    <h4
                        class="text-lg font text-gray-950 font-bold mb-4 min-[500px]:mb-7 text-center min-[500px]:text-left">
                        Bezie os</h4>
                    <ul class="grid gap-4 min-[500px]:gap-6 text-center min-[500px]:text-left">
                        <li><a href="/" class="text-gray-600 link hover:text-gray-900">Home</a></li>
                        <li><a href="/about" class="text-gray-600 link hover:text-gray-900">About</a></li>
                        <li><a href="/gameintro" class="text-gray-600 link hover:text-gray-900">Game Intro</a></li>
                ...
                <div class="block font-mono">
                    <h4
                        ...
                        Products</h4>
                    <ul class="grid gap-4 min-[500px]:gap-6 text-center min-[500px]:text-left">
                        <li><a href="/terms" class="text-gray-600 hover:text-gray-900">Terms and Conditions</a>
                        </li>
                ...
                <div class="bloc font-mono">
                    <h4
                        class="text-lg text-gray-950 font-bold mb-4 min-[500px]:mb-7 text-center min-[500px]:text-left">
                        Resources</h4>
                    <ul class="grid gap-4 min-[500px]:gap-6 text-center min-[500px]:text-left">
            ...
            <div class="block lg:max-w-md font-mono">
                <h3
                ...
                <div
                    class="lg:bg-gray-100 lg:rounded-md black_border max-sm:shadow-none lg:h-16 lg:p-1.5 lg:flex-row gap-6 lg:gap-0 flex-col flex items-center justify-between">
                    <input type="text" name="email"
                        class="py-3 px-6 bg-gray-100 rounded-md text-gray-900 placeholder:text-gray-500 focus:outline-none flex-1 w-full max-w-xl mx-auto lg:w-auto lg:py-5 lg:px-7 lg:bg-transparent"
                        placeholder="Your email here..." />
                    <button type="submit" class="py-3.5 px-7 bg-pink-600 rounded-md black_border text-white pointer  font text_shadow font-semibold hover:bg-pink-400">Subscribe</button>
                </div>
            </div>
        </div>
        <div class="pt-4 border-t border-gray-200 font-mono">
            <div class="flex items-center justify-center flex-col gap-8 lg:gap-0 lg:flex-row lg:justify-between">
                <span class="text-sm text-gray-500 ">©<a href="/" class="text-gray-950">Bezie-os</a> 2024, All rights reserved.</span>
                <div class="flex mt-4 space-x-4 sm:justify-center sm:mt-0 ">
                    <a href="javascript:;"
                        class="w-9 h-9 rounded-md bg-pink-700 black_border flex justify-center items-center hover:bg-pink-500">
                    ...
                    <a href="javascript:;"
                        class="w-9 h-9 rounded-md bg-pink-700  black_border flex justify-center items-center hover:bg-pink-600">
                    ...
                    <a href="javascript:;"
                        class="w-9 h-9 rounded-md bg-pink-700 flex  black_border justify-center items-center hover:bg-pink-500">
                    ...
                    <a href="javascript:;"
                        class="w-9 h-9 rounded-md bg-pink-700 flex justify-center items-center hover:bg-pink-500 black_border">
