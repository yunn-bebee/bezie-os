<div class="flex flex-col p-2 gap-4 w-[10%] absolute top-5">
    ...
    <a href="/child/dictionary"
            class="bg-gray-300 flex items-center flex-col justify-center size-14 rounded-md black_border max-sm:size-10 font-mono">
        <i class="fas fa-dictionary"></i> Words Search
</a>
